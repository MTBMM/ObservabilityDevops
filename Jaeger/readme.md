...
- We have already instrumented our code using OpenTelemetry libraries/packages. For more details, refer to `monitoring/application/service-a/tracing.js` or `monitoring/application/service-b/tracing.js`.
